...
var tasksRaw = {
	'：1-1': [0.47, 0.67, 0.47, 0.67, -0.47],
	'：1-2': [0.87, 0.67, 0.87, 0.67, 0.67],
	'：1-3': [0.8, 0.8, -0.8, 1.0, 1.0],
	'：1-4': [1.13, 1.33, 1.13, 1.13, -1.33],
	'：1-5': [-0.8, 0.8, -0.8, -0.73, 0.73],
	'：1-6': [-1.13, -1.13, -0.93, -0.93, 0.93],
	'：1-7': [-0.67, 0.47, 0.67, 0.47, -0.47],
	'：2-1': [-0.47, -0.47, -0.67, 0.67, -0.47],
	'：2-2': [-1.0, -1.0, -1.0, -1.27, 1.27],
	'：2-3': [-1.4, 1.0, 1.4, 1.0, 1.0],
	'：2-4': [-1.2, -1.2, -1.2, 0.87, 0.87],
	'：2-5': [-0.87, 0.87, -0.6, 0.6, 0.6],
	'：2-6': [1.0, 1.2, 1.0, 1.2, 0.93],
	'：2-7': [0.8, 0.6, -0.8, 0.6, -0.6],
};
 ...
 */
 var levelBonus = {
	...
	'：1-1': [addBonusInfo('SS', 1, "睡衣"), addBonusInfo('SS', 1, "居家服")],
	'：1-2': [addBonusInfo('S', 1, "运动系")],
	'：1-3': [addBonusInfo('A', 1, "泳装")],
	'：1-5': [addBonusInfo('A', 1, "哥特风")],
	'：1-6': [addBonusInfo('B', 0.25, "欧式古典")],
	'：1-7': [addBonusInfo('SS', 1, "洛丽塔")],
	'：2-1': [addBonusInfo('SS', 1, "中式古典")],
	'：2-4': [addBonusInfo('B', 0.25, "哥特风")],
	'：2-5': [addBonusInfo('S', 1, "女仆装")],
	'：2-6': [addBonusInfo('B', 0.25, "海军风")],
	'：2-7': [addBonusInfo('S', 1, "中式现代")],
 };
