...
var tasksRaw = {
	'1-1 睡衣兜风派对': [0.47, 0.67, 0.47, 0.67, -0.47],
	'1-2 温特蒙郊外晨跑': [0.87, 0.67, 0.87, 0.67, 0.67],
	'1-3 海边比基尼对决': [0.8, 0.8, -0.8, 1.0, 1.0],
	'1-4 莉莉丝王国冬天': [1.13, 1.33, 1.13, 1.13, -1.33],
	'1-5 西西亚音乐节': [-0.8, 0.8, -0.8, -0.73, 0.73],
	'1-6 星之海庆功舞会': [-1.13, -1.13, -0.93, -0.93, 0.93],
	'1-7 蔷薇园茶会': [-0.67, 0.47, 0.67, 0.47, -0.47],
	'2-1 游历的收获': [-0.47, -0.47, -0.67, 0.67, -0.47],
	'2-2 菲莉雅名媛舞会': [-1.0, -1.0, -1.0, -1.27, 1.27],
	'2-3 可爱风的面试': [-1.4, 1.0, 1.4, 1.0, 1.0],
	'2-4 冷艳还是优雅': [-1.2, -1.2, -1.2, 0.87, 0.87],
	'2-5 奇怪的指令': [-0.87, 0.87, -0.6, 0.6, 0.6],
	'2-6 最新的水手服': [1.0, 1.2, 1.0, 1.2, 0.93],
	'2-7 黑卡的云端风': [0.8, 0.6, -0.8, 0.6, -0.6],
};
 ...
 */
 var levelBonus = {
	...
	'1-1 睡衣兜风派对': [addBonusInfo('SS', 1, "睡衣"), addBonusInfo('SS', 1, "居家服")],
	'1-2 温特蒙郊外晨跑': [addBonusInfo('S', 1, "运动系")],
	'1-3 海边的比基尼对决': [addBonusInfo('A', 1, "泳装")],
	'1-5 西西亚音乐节': [addBonusInfo('A', 1, "哥特风")],
	'1-6 星之海庆功舞会': [addBonusInfo('B', 0.25, "欧式古典")],
	'1-7 蔷薇园茶会': [addBonusInfo('SS', 1, "洛丽塔")],
	'2-1 游历的收获': [addBonusInfo('SS', 1, "中式古典")],
	'2-4 冷艳还是优雅': [addBonusInfo('B', 0.25, "哥特风")],
	'2-5 奇怪的指令': [addBonusInfo('S', 1, "女仆装")],
	'2-6 最新的水手服': [addBonusInfo('B', 0.25, "海军风")],
	'2-7 黑卡的云端风': [addBonusInfo('S', 1, "中式现代")],
 };
